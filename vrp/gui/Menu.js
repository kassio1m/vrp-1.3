...
Menu.prototype.setSelected = function(i)
{
  ...
  if(this.selected >= 0 && this.selected < this.el_choices.length){
    ...
    if(choice.length > 1){
      ...
      // position description to the left of the menu (bottom-right anchored)
      var menuRight = 30 + this.div.offsetWidth + 10;
      this.div_desc.style.right = menuRight+"px";
      this.div_desc.style.bottom = "30px";
      this.div_desc.style.left = "auto";
      this.div_desc.style.top = "auto";
    }
  }
}
